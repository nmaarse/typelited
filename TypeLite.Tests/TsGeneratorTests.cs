...
namespace TypeLite.Tests {
    public class TsGeneratorTests {
        ...
        public void WhenPropertyIsIgnored_PropertyIsExcludedFromInterface() {
            ...
            builder.Add<Address>();
            var model = builder.Build();
            model.Classes.Single(o => o.Name == "Address").Properties.Single(p => p.Name == "Street").IsIgnored = true;
        ...
        public void WhenFieldIsIgnored_FieldIsExcludedFromInterface() {
            ...
            builder.Add<Address>();
            var model = builder.Build();
            model.Classes.Single(o => o.Name == "Address").Fields.Single(f => f.Name == "PostalCode").IsIgnored = true;
